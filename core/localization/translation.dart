...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          "1": "اختر اللغة",
          "2": "يشتري",
          "3": "تسوق من آلاف الماركات بأسعار رمزية",
          "4": "بيع",
          "5": "انقر فوق قائمة وبيع الأشياء الرائعة\n لكسب نقود سهلة",
          "6": "دردشة",
          "7": "الدردشة للحصول على مزيد من المعلومات والمساومة\n للحصول على سعر أفضل",
          "8": "متابعه",
          "9": "تسجيل الدخول",
          "10": "اهلا بك",
        ...
        "en": {
          "1": "Choose Language",
          "2": "Buy",
          "3":"Shop from thousands of brands \n at throwawy prices!"
              ,
          "4": "Sell",
          "5": "Click, List & Sell cool Stuff to \n earn easy cash.",
          "6": "Chat",
          "7":
